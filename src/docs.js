...
DocsJS.resized = function(){
	...
	if (DocsJS.window.width() > DocsJS.width.max + 200){
		DocsJS.apply(function(doc){
			...
			DocsJS.forEach(doc.querySelectorAll(':scope > main > [docsjs-tag="s-c"]'),function(el){
